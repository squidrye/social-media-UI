...
import 'package:social_media_demo/Screen/ImagePicker/filterUtils.dart';
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            if (snapshot.hasError) {
              ...
              FilterUtils.saveCachedFilter(filter, snapshot.data!.toList());

              return buildFilter(snapshot.data!.toList());
            }
        }
      },
    );
